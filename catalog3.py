...
class catalog4(Resource):
	...
	def post(self, video_id):
		...
		db.session.commit()
		response = requests.put("http://192.168.1.50:7000/" + "follow_up_update" , {   "item_id"  :video_id ,"number_in_stock" :result.number_in_stock ,"cost" :result.cost , "topic" :result.topic})
...
def add_product128(id):
  ...
  response = requests.put("http://192.168.1.50:7000/" + "follow_up_create" ,  {"item_id" :id   ,"topic" :args['topic'] , "cost" :args['cost'] ,"number_in_stock" :args ['number_in_stock'] , "titel" :args['titel'] })
